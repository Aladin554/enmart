                    ...
                    <form action="{{ route('admin.settings.updatePaymentMethods') }}" method="POST"
                        ...
                        <div class="card mb-4" id="section-7">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label for="SSLCZ_STORE_ID" class="form-label">{{ localize('SslCommerz ID') }}</label>
                                    <input type="hidden" name="types[]" value="SSLCZ_STORE_ID">
                                    <input type="text" id="SSLCZ_STORE_ID" name="SSLCZ_STORE_ID" class="form-control"
                                        value="{{ env('SSLCZ_STORE_ID') }}">
                                </div>
                                <div class="mb-3">
                                    <label for="SSLCZ_STORE_PASSWORD"
                                        class="form-label">{{ localize('SslCommerz PASSWORD') }}</label>
                                    <input type="hidden" name="types[]" value="SSLCZ_STORE_PASSWORD">
                                    <input type="text" id="SSLCZ_STORE_PASSWORD" name="SSLCZ_STORE_PASSWORD"
                                        class="form-control" value="{{ env('SSLCZ_STORE_PASSWORD') }}">
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">{{ localize('Enable SslCommerz') }}</label>
                                    <select id="enable_SslCommerz" class="form-control select2" name="enable_SslCommerz"
                                        data-toggle="select2">
                                        <option value="0"
                                            {{ getSetting('enable_SslCommerz') == '0' ? 'selected' : '' }}>
                                            {{ localize('Disable') }}</option>
                                        <option value="1"
                                            {{ getSetting('enable_SslCommerz') == '1' ? 'selected' : '' }}>
                                            {{ localize('Enable') }}</option>
                                    </select>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tt-vertical-step">
                                <ul class="list-unstyled">
                                    ...
                                    <li>
                                        <a href="#section-7">{{ localize('SslCommerz Credentials') }}</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
